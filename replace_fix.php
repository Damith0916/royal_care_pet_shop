...
$backupFile = 'c:\\wamp64\\www\\smart percare\\smartpetcare\\resources\\js\\Pages\\NewCase\\Index_backup2.jsx';

// Since the file is already modified, we better use the backup and apply the correct replacement.
...
if (count($matches) > 0) {
    ...
    echo "Successfully replaced the layout with two extra closing tags.\n";
} else {
